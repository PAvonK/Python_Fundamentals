...
class Message(object):
    ...
    def build_shift_dict(self, shift): #Done
        '''
        ...
        for char in range(26):
            ...
            encrypting_dict[letter] = lowerBaseList[char + shift]

        for char in range(26):
            letter = upperBaseList[char]
            encrypting_dict[letter] = upperBaseList[char + shift]

        return encrypting_dict

    def apply_shift(self, shift): #Done
        '''
