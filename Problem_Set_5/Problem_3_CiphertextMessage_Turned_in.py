# -*- coding: utf-8 -*-
"""
Created on Sat Mar  7 20:54:53 2020
...
and PlaintextMessage classes, so don't worry if you did not get the previous 
parts correct.
...
are actual words. It is possible to have a message that can be decoded by 
two separate shifts into different sets of words. While there are various 
...
__init__(self, text): Use the parent class constructor to make your code 
more concise.
...
Hints
Using string.split
You may find the function string.split useful for dividing the text up 
into words.
