# bisection search 3000, functions - 4000, branching - 1000
...
def isIn(char, aStr):
    ...
    '''
    # Your code here
    if len(aStr)==0: #Makes sure str has charcters in it
        return False
    elif len(aStr)==1: #This is the base part 1
        return char == aStr
    elif char == aStr[len(aStr)//2]:# Base part 2, it checks both
        return True
    else: # This else clause is the bisection and the check if it is in
