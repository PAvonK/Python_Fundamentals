...
class Professor(MITPerson):
    ...
    def speak(self, utterance):  # this methos shadows the MITPerson speak method
        newUtterance = 'In course ' + self.department + ' we say '
        return MITPerson.speak(self, newUtterance + utterance)
        
    def lecture(self, topic):   # this is it's own speak method
...
print()
print(m1.speak('hi there')) # Mark Zuckerberg says: hi there
print(s1.speak('hi there')) #Matt Damon says:  Dude, hi there
print(faculty.speak('hi there')) # Doctor Arrogant says: In course six we say hi there
print(faculty.lecture('hi there')) # Doctor Arrogant says: In course six we say it is obvious that hi there
